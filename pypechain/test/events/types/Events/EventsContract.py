...
class EventsEmitNoEventsContractFunction0(PypechainContractFunction):
    ...
    _error_class = EventsContractErrors
...
class EventsEmitNoEventsContractFunction(PypechainOverloadedFunctions):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._overloaded_functions = {
            EventsEmitNoEventsContractFunction0._type_signature: EventsEmitNoEventsContractFunction0,
        }
        return out
...
class EventsEmitOneEventContractFunction(PypechainOverloadedFunctions):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._overloaded_functions = {
            EventsEmitOneEventContractFunction0._type_signature: EventsEmitOneEventContractFunction0,
        }
        return out
...
class EventsEmitTwoEventsContractFunction(PypechainOverloadedFunctions):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._overloaded_functions = {
            EventsEmitTwoEventsContractFunction0._type_signature: EventsEmitTwoEventsContractFunction0,
        }
        return out
...
class EventsContractEvents(ContractEvents):
    ...
    def __init__(
        ...
        self.EventA = EventsEventAContractEvent.factory(
            "EventA", w3=w3, contract_abi=abi, address=address, event_name="EventA"
        )
        self.EventB = EventsEventBContractEvent.factory(
            "EventB", w3=w3, contract_abi=abi, address=address, event_name="EventB"
        )
...
class EventsContract(Contract):
    ...
    _raw_bytecode: HexStr | None = HexStr(
        ""
    )
