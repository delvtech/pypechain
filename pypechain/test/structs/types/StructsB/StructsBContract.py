...
class StructsBNoNameSingleValueContractFunction0(PypechainContractFunction):
    ...
    _error_class = StructsBContractErrors
...
class StructsBNoNameSingleValueContractFunction(PypechainOverloadedFunctions):
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._overloaded_functions = {
            StructsBNoNameSingleValueContractFunction0._type_signature: StructsBNoNameSingleValueContractFunction0,
        }
        return out
...
class StructsBSingleSimpleStructContractFunction(PypechainOverloadedFunctions):
    """ContractFunction for the singleSimpleStruct method."""
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._overloaded_functions = {
            StructsBSingleSimpleStructContractFunction0._type_signature: StructsBSingleSimpleStructContractFunction0,
        }
        return out
...
class StructsBContract(Contract):
    ...
    _raw_bytecode: HexStr | None = HexStr(
        ""
    )
