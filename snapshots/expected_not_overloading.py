...
class OverloadedBalanceOfWhoContractFunction(PypechainOverloadedFunctions):
    ...
    def factory(
        ...
        out._overloaded_functions = {
            ...
            OverloadedBalanceOfWhoContractFunction0._type_signature: OverloadedBalanceOfWhoContractFunction0,
